...
(function() {
  ...
  window.GM_xmlhttpRequest = function(o) {
    ...
    x.onload = function() { if(o.onload) o.onload({responseText:x.responseText,status:x.status}); };
    x.onerror = function() { if(o.onerror) o.onerror({statusText:x.statusText}); };
    x.send(o.data||null);
  };
  window.GM_notification = function(t) { console.log('[GM]',t); };
  window.GM_getResourceText = function(n) { return ''; };
  // ==/UserScript==
